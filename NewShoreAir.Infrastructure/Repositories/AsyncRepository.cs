...
{
    public class AsyncRepository<T> : IAsyncRepository<T> where T : BaseDomainModel
    {
        protected readonly NewShoreAirDbContext _context;

        public AsyncRepository(NewShoreAirDbContext context)
        {
            _context = context;
        }
